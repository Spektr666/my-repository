...
11. 7 kyu https://www.codewars.com/kata/mylanguages
 ...
 function myLanguages(results) {
  return Object.keys(results).filter(score=>results[score]>59).sort((a,b) => results[b] - results[a]);
}
...
с обьектами пока проблема, не особо понимаю как работать и сортировать их.
в общем буду разбираться еще
